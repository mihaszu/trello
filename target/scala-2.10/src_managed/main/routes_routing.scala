...
// @LINE:21
private[this] lazy val controllers_Projects_rename5 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+""",true))))
        

// @LINE:23
private[this] lazy val controllers_Projects_addUser6 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+""",true),StaticPart("/team"))))
        

// @LINE:27
private[this] lazy val controllers_Tasks_index7 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+""",true),StaticPart("/tasks"))))
        

// @LINE:28
private[this] lazy val controllers_Tasks_add8 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+""",true),StaticPart("/tasks"))))
        

// @LINE:29
private[this] lazy val controllers_Tasks_update9 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tasks/"),DynamicPart("task", """[^/]+""",true))))
        

// @LINE:30
private[this] lazy val controllers_Tasks_delete10 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tasks/"),DynamicPart("task", """[^/]+""",true))))
        

// @LINE:32
private[this] lazy val controllers_Tasks_addFolder11 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tasks/folder"))))
        

// @LINE:33
private[this] lazy val controllers_Tasks_deleteFolder12 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("projects/"),DynamicPart("project", """[^/]+""",true),StaticPart("/tasks/folder"))))
        

// @LINE:34
private[this] lazy val controllers_Tasks_renameFolder13 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("project/"),DynamicPart("project", """[^/]+""",true),StaticPart("/tasks/folder"))))
        

// @LINE:37
private[this] lazy val controllers_Application_javascriptRoutes14 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("assets/javascripts/routes"))))
...
// @LINE:21
case controllers_Projects_rename5(params) => {
   call(params.fromPath[Long]("project", None)) { (project) =>
        invokeHandler(controllers.Projects.rename(project), HandlerDef(this, "controllers.Projects", "rename", Seq(classOf[Long]),"PUT", """DELETE  /projects/:project                  controllers.Projects.delete(project: Long)""", Routes.prefix + """projects/$project<[^/]+>"""))
   }
}
        

// @LINE:23
case controllers_Projects_addUser6(params) => {
   call(params.fromPath[Long]("project", None)) { (project) =>
...
// @LINE:27
case controllers_Tasks_index7(params) => {
   call(params.fromPath[Long]("project", None)) { (project) =>
...
// @LINE:28
case controllers_Tasks_add8(params) => {
...
// @LINE:29
case controllers_Tasks_update9(params) => {
...
// @LINE:30
case controllers_Tasks_delete10(params) => {
   call(params.fromPath[Long]("task", None)) { (task) =>
...
// @LINE:32
case controllers_Tasks_addFolder11(params) => {
   call { 
...
// @LINE:33
case controllers_Tasks_deleteFolder12(params) => {
   call(params.fromPath[Long]("project", None), params.fromQuery[String]("folder", None)) { (project, folder) =>
...
// @LINE:34
case controllers_Tasks_renameFolder13(params) => {
   call(params.fromPath[Long]("project", None), params.fromQuery[String]("folder", None)) { (project, folder) =>
